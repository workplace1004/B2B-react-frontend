...
export default function SalesReps() {
  ...
  const users = data || [];
  const salesReps = users.filter((user: any) => user.role === 'SALES' || user.role === 'B2B');
    ...
    <div>
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between">
          ...
          {(!salesReps || salesReps.length === 0) ? null : (
        ...
        {salesReps.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-16 px-4">
            ...
            <p className="text-gray-500 dark:text-gray-400 mb-6 text-center max-w-md">
              Get started by adding your first sales rep account.
            </p>
            <button className="flex items-center gap-2 px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition-colors">
              <Plus className="w-5 h-5" />
              Add Sales Rep
          ...
          <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            <thead className="bg-gray-50 dark:bg-gray-700">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider">Commissions</th>
              ...
              {salesReps.map((rep: any) => {
                ...
                return (
                  <tr key={rep.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-white">{rep.email}</td>
