      ...
      <div className="mb-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400 mt-1">Calendar view for drops, launches, and promotions</p>
          </div>
          <button
          ...
          {formData.type === 'DROP' && !isDrop && (
            <div>
              ...
              <select
                ...
                onChange={(e) => setFormData({ ...formData, collectionId: e.target.value ? parseInt(e.target.value) : undefined })}
