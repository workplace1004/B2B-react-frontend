...
export default function Service() {
  ...
  return (
    <div>
      <Breadcrumb currentPage="Service" />
      <div className="mb-6">
        ...
        {returns.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-16 px-4">
            <div className="w-24 h-24 bg-gray-100 dark:bg-gray-700 rounded-full flex items-center justify-center mb-4">
              <Headset className="w-12 h-12 text-gray-400 dark:text-gray-500" />
            </div>
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">No service cases found</h3>
            <p className="text-gray-500 dark:text-gray-400 mb-6 text-center max-w-md">
              Returns status (RMA lookup), case/issue log
            </p>
          </div>
        ) : (
