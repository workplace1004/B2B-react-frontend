...
export default function Layout({ children }: LayoutProps) {
  ...
  return (
    <div className={`min-h-screen ${darkMode ? 'dark bg-gray-900' : 'bg-gray-50'}`}>
      ...
      <aside className="fixed left-0 top-0 bottom-0 w-[320px] bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 z-50 flex flex-col">
        {/* Logo at top */}
        ...
        <div className="fixed top-0 left-[88px] right-0 h-16 flex z-40">
          {/* Sidebar Brand Section */}
          <div className={`h-20 flex items-center justify-between px-4 border-r border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 transition-all duration-300 ${sidebarOpen ? 'w-72' : 'w-20'
            }`}>
            {sidebarOpen ? (
              <>
                <div>
        ...
        {/* Sidebar */}
        <aside
          className={`fixed left-[88px] top-20 bottom-0 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 transition-all duration-300 z-30 flex flex-col ${sidebarOpen ? 'w-72' : 'w-20'
            }`}
        >
      ...
      {/* Main Content */}
      <main
        className={`pt-20 transition-all duration-300 bg-gray-50 dark:bg-gray-900 ${sidebarOpen ? 'ml-[368px]' : 'ml-[100px]'
          }`}
      >
