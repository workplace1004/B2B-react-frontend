...
export default function Layout({ children }: LayoutProps) {
  ...
  const sidebarItemsMap: Record<string, SidebarItem[]> = {
    dashboards: [
      { path: '/executive-overview', label: 'Executive Dashboard', useFlaticon: true, flaticonClass: 'fi fi-rr-house-blank', section: 'overview' },
      ...
      { path: '/finance-dashboard', label: 'Marketing Dashboard', useFlaticon: true, flaticonClass: 'fi fi-rr-growth-chart-invest', section: 'overview' },
